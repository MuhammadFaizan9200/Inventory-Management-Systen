...
<head>
    <title>Chart Of Accounts | Ppipopular</title>
                   ...
                   <div class="container-fluid flex-grow-1 container-p-y">
                    ...
                    <div class="form-row">                          
                        <div class="form-group col-md-4">
                                 <h4 class="font-weight-bold py-3 mb-0">New Chart Of Accounts</h4>
                            <ol class="breadcrumb">
                        ...
                        <div class="form-group col-md-3">
                            <h4 class="font-weight-bold py-3 mb-0"></h4>
                             <ol class="breadcrumb">
                               <a href="add_customer.php"  class="btn btn-primary btn btn-block add_product"  style="width:100%" >Add Chart Of Accounts</a>
                            </ol>
                             <div class="clearfix"></div>   
                        </div>
                    </div>    
                        ...
                        <div class="card">
                             <h3 class="card-header" align="Center"><i class="oi oi-spreadsheet" style="font-size:35px; "></i> &nbsp; Chart Of Accounts List</h3>
                            <div class="card-body">
                                ...
                                <tbody>
                                    <?php
                                     $count = 1;
                                            ...
                                            if($customer_type == 1){
                                                $customer_type_text = 'Cash';
                                            }elseif ($customer_type == 10) {
                                                # code...
                                                 $customer_type_text = 'Bank';
                                            }elseif ($customer_type == 3) {
                                                # code...
                                                 $customer_type_text = 'Expense';
                                            }elseif ($customer_type == 4) {
                                                # code...
                                                 $customer_type_text = 'Supplier/Vendor';
                                            }elseif ($customer_type == 5) {
                                                # code...
                                                 $customer_type_text = 'Customer';
                                            }elseif ($customer_type == 6) {
                                                # code...
                                                 $customer_type_text = 'Company';
                                            }elseif ($customer_type == 7) {
                                                # code...
                                                 $customer_type_text = 'Others';
                                            }
