                   ...
                   <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                            <ol class="breadcrumb">
                             ...
                             <ol class="breadcrumb">
                               <a href="stock_transfer.php"  class="btn btn-primary btn btn-block add_product"  style="width:20%" >Stock Transfer</a>
                            </ol>
                        </div> -->
                    ...
                    <div class="form-row">                          
                        ...
                        <div class="form-group col-md-3">
                            <h4 class="font-weight-bold py-3 mb-0"></h4>
                             <ol class="breadcrumb">
                               <a href="stock_transfer.php"  class="btn btn-primary btn btn-block add_product"  style="width:100%" >Stock Transfer</a>
                            </ol>
                             <div class="clearfix"></div>   
                        </div>
                    </div>   
                        ...
                        <div class="card">
                             <h3 class="card-header bg-primary text-white" align="Center"><i class="oi oi-spreadsheet" style="font-size:35px; "></i> &nbsp; Transfer Details</h3>
                                ...
                                <tbody>
                                    ...
                                    echo"<tr> 
                                          ...
                                          <td>$invoiceNumber</td>
                                           <td>$vendorName</td>
                                           <td>$date</td>
                                           <td><a href='fetch-transfer-details.php?id=$purchaseInvoiceID'><img src='assets/img/view.svg'   style='width: 25px;height: 25px;cursor:pointer'></a></td>
                                         </tr>";
                                    $count++;
