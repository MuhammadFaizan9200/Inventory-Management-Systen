...
<head>
    <title>Six Floor Godown | Ppipopular</title>
        ...
        <div class="layout-inner">
            ...
            <!-- Modal template end-->
                   ...
                   <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Six Floor Godown</h4>
                        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item">Dashboard</li>
                                <li class="breadcrumb-item active">Six Floor Godown</li>
                            </ol>
                        </div>
                        ...
                        <div class="card">
                             <h3 class="card-header bg-primary text-white" align="Center"><i class="oi oi-spreadsheet" style="font-size:35px; "></i> &nbsp; Six Floor Godown List</h3>
                            ...
                            <table class="datatables-demo table table-striped table-bordered" id="editable-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Product Type</th>
                                        <th>Product Name</th>
                                        <th>Godwn Six Floor Quantity</th>
                                ...
                                <tbody>
                                    <?php
                                     $count = 1;
                                            $fetch_query = "SELECT  SUM(godown_six.godown_sith_quantity) as sixFloorQuantity ,(SELECT product_name from products WHERE id = godown_six.productID) as productName ,(SELECT category_name from category WHERE id = godown_six.categoryID) as categoryName FROM godown_6th_floor godown_six, products p WHERE p.id = godown_six.productID  GROUP by `productID`";
                                            $sth = $dbh->prepare($fetch_query);
                                            $result = $sth->execute();
                                            while($rows = $sth->fetch(PDO::FETCH_ASSOC)){
                                             $sixFloorQuantity = $rows['sixFloorQuantity']; 
